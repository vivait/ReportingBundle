...
!! Important Note, there is an issue with Doctrine [*~~DDC-3108~~*](https://github.com/doctrine/doctrine2/pull/1212). This means that you will not be able to use aliases from anything but the base table (ie Joins) unless you use a version of doctrine that supports it.
